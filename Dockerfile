...
# Copy src to keep compatibility with current module path 'src.agent_server.main:app'
COPY src/ ./src/
...
CMD sh -c "alembic upgrade head && uvicorn src.agent_server.main:app --host 0.0.0.0 --port ${PORT:-8000}"
